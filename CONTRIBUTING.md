Contributing to nickoin Core
============================

The nickoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the nickoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/nickoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to nickoin-qt
...
The following applies to code changes to the nickoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall nickoin
Network Protocol consensus changes.

Whether a pull request is merged into nickoin Core rests with the project merge
...
Patches that change nickoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the nickoin consensus, it must have been
...
The project leader is the release manager for each nickoin Core release.
