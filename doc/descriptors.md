# Support for Output Descriptors in nickoin Core

Since nickoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `nck1...` for mainnet or `tnck1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing nickoin Core wallets, a convenience function `combo` is
