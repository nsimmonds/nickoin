...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 nicks per kB (0.00001 LTC). This is to prepare for dropping the minimum transaction fee to 0.1 nicks per kB (0.0001 LTC) in the next release.
