...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nickoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nickoin-tx [options] <hex-tx> [commands]  Update hex-encoded nickoin transaction\n" +
            "or:     nickoin-tx [options] -create [commands]   Create hex-encoded nickoin transaction\n" +
            "\n";
