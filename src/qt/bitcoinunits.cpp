...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("nickoins");
    case mBTC: return QString("nicks (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("enns (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
