...
const char * const BITCOIN_CONF_FILENAME = "nickoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "nickoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/nickoin";
#else
    // Unix-like
    return pathRet / ".nickoin";
#endif
#endif
}
