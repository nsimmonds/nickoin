...
"""Verify that starting nickoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nickoin with -h for help text")
        ...
        self.log.info("Start nickoin with -version for version information")
        ...
        self.log.info("Start nickoind with -fakearg to make sure it does not start")
